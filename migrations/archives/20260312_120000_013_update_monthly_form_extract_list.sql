-- Migration: Update Monthly Weight Recording Form extract_list
-- Date: 2026-03-12
-- Description: Move location_name inside daily_entries (per-entry level) and improve extraction guidance
